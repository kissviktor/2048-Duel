...
def instructions_3():
    ...
    while True:
        ...
        #   Negyedik tipp
        inst_4_1 = "4, With your movement keys"
        inst_4_2 = "you move all the tiles on"
        inst_4_3 = "the board simultaneously."


        label_text_4_1 = text_font.render(inst_4_1, True, (0, 0, 0))
        label_text_4_1_rect = label_text_4_1.get_rect(
            center=(int(600 / 2), 200))
        window.blit(label_text_4_1, label_text_4_1_rect)

        label_text_4_2 = text_font.render(inst_4_2, True, (0, 0, 0))
        label_text_4_2_rect = label_text_4_2.get_rect(
            center=(int(600 / 2), 250))
        window.blit(label_text_4_2, label_text_4_2_rect)

        label_text_4_3 = text_font.render(inst_4_3, True, (0, 0, 0))
        label_text_4_3_rect = label_text_4_3.get_rect(
            center=(int(600 / 2), 300))
        window.blit(label_text_4_3, label_text_4_3_rect)

        #   Ötödik tipp
        inst_5_1 = "5, With your every move "
        inst_5_2 = "the game will spawn a new"
        inst_5_3 = "tile with the lowest value (2)"
        inst_5_4 = "which is the base unit."

        label_text_5_1 = text_font.render(inst_5_1, True, (0, 0, 0))
        label_text_5_1_rect = label_text_5_1.get_rect(
            center=(int(600 / 2), 400))
        window.blit(label_text_5_1, label_text_5_1_rect)

        label_text_5_2 = text_font.render(inst_5_2, True, (0, 0, 0))
        label_text_5_2_rect = label_text_5_2.get_rect(
            center=(int(600 / 2), 450))
        window.blit(label_text_5_2, label_text_5_2_rect)

        label_text_5_3 = text_font.render(inst_5_3, True, (0, 0, 0))
        label_text_5_3_rect = label_text_5_3.get_rect(
            center=(int(600 / 2), 500))
        window.blit(label_text_5_3, label_text_5_3_rect)

        label_text_5_4 = text_font.render(inst_5_4, True, (0, 0, 0))
        label_text_5_4_rect = label_text_5_4.get_rect(
            center=(int(600 / 2), 550))
        window.blit(label_text_5_4, label_text_5_4_rect)
